...
insert into account (account_id, nickname) values (1, 'user1');
insert into account (account_id, nickname) values (2, 'user2');
insert into account (account_id, nickname) values (3, 'user3');
insert into account (account_id, nickname) values (4, 'user4');
